...
<section class="content">
        <div class="container-fluid">
            <div> 
                <a href="{{route('author.post.create')}}" class="btn btn-success"><i class="material-icons">add</i>Add New Post</a> </br></br>
            </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($posts as $post) 
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{route('author.post.show',$post->id)}}" class="btn btn-warning">
                                                                    ...
                                                                    <form id="post_delete_form_{{$post->id}}" action="{{route('author.post.destroy',$post->id)}}" method="post" style="display :none;" >
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    </form>
                                                                </td>
