                        ...
                        <div class="col-sm-12">
                                <div class="card">
                                        <div class="header">
                                            <h2>
                                                Favorite Lists
                                                <span class=" badge bg-deep-orange" >{{ $comments->count() }}</span>
                                            </h2>
                                        </div>
                                        <div class="body">
                                                        ...
                                                        @foreach ($comments as $key => $comment) 
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <form id="comment_delete_form_{{$comment->id}}" action="{{route('admin.comment.destroy',$comment->id)}}" method="post" style="display :none;" >
                                                                        @csrf
                                                                        @method('DELETE')
                                                                    </form>
                                                                </td>
